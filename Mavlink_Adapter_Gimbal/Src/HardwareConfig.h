...
#define HARDWARE_CONFIG_H
  ...
  #include "ButtonDriver.h"
	...
	#define set_run_led() ledAction(run_led, GPIO_PIN_RESET)//0
	#define reset_run_led() ledAction(run_led, GPIO_PIN_SET)//1
	...
	/* RGB2 */
	#define RGB2_RLED(sw) HAL_GPIO_WritePin(GPIOB, LED_RED_Pin, sw)
	#define RGB2_GLED(sw) HAL_GPIO_WritePin(GPIOB, LED_GRE_Pin, sw)
	#define RGB2_BLED(sw) HAL_GPIO_WritePin(GPIOB, LED_BULE_Pin, sw)
