...
int insertCharLoopQueue( LoopQueue* loopQueue, unsigned char value )					//insert element to queue//²åÈë
{
	if( loopQueue==0 )
	{
		return 0;
...
unsigned char readCharLoopQueue( LoopQueue* loopQueue )					//read element in queue//¶ÁÈ¡
{
	unsigned char uc = 0;	
	if( loopQueue==0 )
	{
